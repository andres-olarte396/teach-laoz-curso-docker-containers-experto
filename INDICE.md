# Índice del Curso: Docker y Containers - De 0 a Experto

Bienvenido al índice maestro del curso. Aquí encontrarás enlaces directos a todo el contenido teórico, práctico y evaluaciones.

---

## 📚 Estructura del Curso

### [Módulo 0: Preconceptos](modulos/modulo_0/00_PRESENTACION.md)

_Conceptos fundamentales de virtualización y sistemas operativos._

- **0.1 Preconceptos Esenciales**
  - [Virtualización y Kernel](modulos/modulo_0/tema_0_preconceptos.md)
...
### [Módulo 2: Maestría en Imágenes (Dockerfiles)](modulos/modulo_2/00_PRESENTACION.md)
...
### [Módulo 3: Networking y Persistencia](modulos/modulo_3/00_PRESENTACION.md)
...
### [Módulo 4: Docker Compose](modulos/modulo_4/00_PRESENTACION.md)
...
### [Módulo 5: Seguridad y Producción](modulos/modulo_5/00_PRESENTACION.md)
...
### [Módulo 6: Orquestación (Swarm)](modulos/modulo_6/00_PRESENTACION.md)
...
### [Módulo 7: Fundamentos de Kubernetes](modulos/modulo_7/00_PRESENTACION.md)
...
- **[Referencias y Sustento Técnico](REFERENCIAS.md)**
- **[Guía de Preconceptos (Módulo 0)](modulos/modulo_0/tema_0_preconceptos.md)**

---

_Generado por Teach-Laoz Course Generator - 2025_
